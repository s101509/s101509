    ...
    box.addEventListener('click', function(e) {
        if (!end) {
            if (slot[e.target.slot] == "") {
                ...
                if ((slot[0] == slot[1] && slot[1] == slot[2] && slot[2] != "") ||
                    (slot[3] == slot[4] && slot[4] == slot[5] && slot[5] != "") ||
                    (slot[6] == slot[7] && slot[7] == slot[8] && slot[8] != "") ||
                    (slot[0] == slot[3] && slot[3] == slot[6] && slot[6] != "") ||
                    (slot[1] == slot[4] && slot[4] == slot[7] && slot[7] != "") ||
                    (slot[2] == slot[5] && slot[5] == slot[8] && slot[8] != "") ||
                    (slot[0] == slot[4] && slot[4] == slot[8] && slot[8] != "") ||
